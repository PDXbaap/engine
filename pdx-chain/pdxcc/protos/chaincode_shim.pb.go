...
const (
	...
	ChaincodeMessage_BAAP_STREAM         ChaincodeMessage_Type = 1024
	ChaincodeMessage_BAAP_QUERY          ChaincodeMessage_Type = 1025
)
...
func (x *chaincodeSupportRegisterClient) Send(m *ChaincodeMessage) error {
	//log.Info("chaincodeSupportRegisterClient Send...")
...
func (x *chaincodeSupportRegisterServer) Send(m *ChaincodeMessage) error {
	//log.Info("chaincodeSupportRegisterServer Send...")
