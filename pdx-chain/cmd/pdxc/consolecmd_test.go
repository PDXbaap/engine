...
func TestConsoleWelcome(t *testing.T) {
	...
	// Start a pdxc console, make sure it's cleaned up and terminate the console
	geth := runGeth(t,
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	// Attach to a running pdxc note and terminate immediately
