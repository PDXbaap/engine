...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "pdxc.ipc", false, filepath.Join(os.TempDir(), "pdxc.ipc")},
		{"data", "pdxc.ipc", false, "data/pdxc.ipc"},
		{"data", "./pdxc.ipc", false, "./pdxc.ipc"},
		{"data", "/pdxc.ipc", false, "/pdxc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "pdxc.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "pdxc.ipc", true, `\\.\pipe\geth.ipc`},
