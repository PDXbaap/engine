...
//PDX
func (dlp *downloadTesterPeer) RequestCommitsByNumber(origin uint64, amount int, skip int, reverse bool) error {
	return nil
}

func (dlp *downloadTesterPeer) RequestLatest() error {
	return nil
}
...
//PDX
func (ftp *floodingTestPeer) RequestCommitsByNumber(from uint64, count, skip int, reverse bool) error {
	return nil
}

func (ftp *floodingTestPeer) RequestLatest() error {
	return nil
}
