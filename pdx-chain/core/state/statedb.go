...
func (db *StateDB) ForEachPDXStorage(addr common.Address, cb func(key common.Hash, value []byte) bool) {
	so := db.getStateObject(addr)
	if so == nil {
		return
	}
...
func (s *StateDB) Commit(deleteEmptyObjects bool) (root common.Hash, err error) {
	...
	log.Debug("Trie cache stats after commit", "misses", trie.CacheMisses(), "unloads", trie.CacheUnloads(), "root", root)
	return root, err
}
